...
type UpdateUserInfo struct {
	...
	Id       int32  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`            // 要知道用户是谁才能更新
...
type UserInfoResponse struct {
	...
	Birthday uint64 `protobuf:"varint,5,opt,name=birthday,proto3" json:"birthday,omitempty"` // timestamp的本质是数字，时间没有负数，所以用uint64，处理起来还方便一点
