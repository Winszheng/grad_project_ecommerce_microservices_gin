...
import (
	...
	"github.com/Winszheng/grad_project_ecommerce_microservices_gin/services_basic/order/handler"
...
var Port = flag.Int("port", 50052, "端口号")
...
func main() {
	...
	err = client.Agent().ServiceRegister(&api.AgentServiceRegistration{
		...
		ID:      serviceID,
		Port:    *Port,
		Tags:    []string{"order", "basic_service"},
		Address: "127.0.0.1",
