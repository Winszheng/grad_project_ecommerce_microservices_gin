...
type ItemBrandResponse struct {
	...
	Id       int32              `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	Brand    *BrandInfoResponse `protobuf:"bytes,2,opt,name=brand,proto3" json:"brand,omitempty"`       // 这个字段貌似根本没用上
	Category *ItemInfoResponse  `protobuf:"bytes,3,opt,name=category,proto3" json:"category,omitempty"` // 这个字段貌似也没有用上
}
...
type ItemListResponse struct {
	...
	JsonData string              `protobuf:"bytes,3,opt,name=jsonData,proto3" json:"jsonData,omitempty"` // 我也不清楚这是干嘛点，先学着做吧
}
