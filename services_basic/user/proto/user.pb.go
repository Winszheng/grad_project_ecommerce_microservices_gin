...
type CheckPasswordInfo struct {
	...
	EncrytedPassword string `protobuf:"bytes,2,opt,name=encrytedPassword,proto3" json:"encrytedPassword,omitempty"` // 加密后的密码
}
...
func (x *CheckPasswordInfo) GetEncrytedPassword() string {
	if x != nil {
...
type UpdateUserInfo struct {
	...
	Nickname string `protobuf:"bytes,2,opt,name=nickname,proto3" json:"nickname,omitempty"` // 可以更新的信息
...
type PageInfo struct {
	...
	Pn    uint32 `protobuf:"varint,1,opt,name=pn,proto3" json:"pn,omitempty"`       // page number 页码, 不会是负数，用了这个可以多保存点数据
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` // 页大小，每页能放几个用户
}
...
type UserInfoResponse struct {
	...
	Role     int32  `protobuf:"varint,7,opt,name=role,proto3" json:"role,omitempty"` // uint也可以，无非是uint的数字可以更大一些
}
...
type UserListResponse struct {
	...
	Total int32               `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"` // 一共有多少用户
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    // 切片，切片里每个元素是一个user
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x70, 0x74, 0x79, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5b, 0x0a, 0x11, 0x43, 0x68, 0x65,
	...
	0x63, 0x72, 0x79, 0x74, 0x65, 0x64, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x65, 0x6e, 0x63, 0x72, 0x79, 0x74, 0x65, 0x64, 0x50, 0x61,
	0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x29, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x52,
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65,
	0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73,
	0x73, 0x22, 0x70, 0x0a, 0x0e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49,
	...
	0x64, 0x61, 0x79, 0x22, 0x27, 0x0a, 0x0d, 0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x52, 0x65, 0x71,
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x22, 0x30, 0x0a, 0x08, 0x50, 0x61, 0x67,
	...
	0x12, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x49,
...
var file_user_proto_depIdxs = []int32{
	...
	5, // 1: UserID.GetUserList:input_type -> PageInfo
	3, // 2: UserID.GetUserByMobile:input_type -> MobileRequest
	4, // 3: UserID.GetUserById:input_type -> IdRequest
	6, // 4: UserID.CreateUser:input_type -> CreateUserInfo
	2, // 5: UserID.UpdateUser:input_type -> UpdateUserInfo
	0, // 6: UserID.CheckPassword:input_type -> CheckPasswordInfo
	8, // 7: UserID.GetUserList:output_type -> UserListResponse
	7, // 8: UserID.GetUserByMobile:output_type -> UserInfoResponse
	7, // 9: UserID.GetUserById:output_type -> UserInfoResponse
	7, // 10: UserID.CreateUser:output_type -> UserInfoResponse
	9, // 11: UserID.UpdateUser:output_type -> google.protobuf.Empty
	1, // 12: UserID.CheckPassword:output_type -> CheckResponse
