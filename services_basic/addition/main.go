...
import (
	...
	"github.com/Winszheng/grad_project_ecommerce_microservices_gin/services_basic/addition/handler"
...
var Port = flag.Int("port", 50051, "端口号")
...
func main() {
	...
	err = client.Agent().ServiceRegister(&api.AgentServiceRegistration{
		...
		ID:      serviceID,
		Port:    *Port,
		Tags:    []string{"addition", "basic_service"},
		Address: "127.0.0.1",
